...
@inline function Random.rand!(A::AbstractStrideArray, args::Vararg{Number,K}) where {K}
  rand!(local_rng(), A, args...)
end
@inline function Random.randn!(A::AbstractStrideArray, args::Vararg{Number,K}) where {K}
